...
export class ClientService {
  ...
  getAll = (): Observable<Array<Client>> => {
    return this.http.get<Array<Client>>(`${this.API_URL}/client`);
  };
  ...
  post = (data: Client): Observable<Client> => {
    return this.http.post<Client>(`${this.API_URL}/client`, data);
  };
  ...
  put = (id: number, data: Client): Observable<Client> => {
    return this.http.put<Client>(`${this.API_URL}/client/${id}`, data);
  };
  ...
  delete = (id: number): Observable<Client> => {
    return this.http.delete<Client>(`${this.API_URL}/client/${id}`);
  };
}
